...
class SSH:
    def __init__(self, hostname="127.0.0.1", port=SSH_PORT, username='root', pkey=None, password=None, connect_timeout=10):
...
if __name__ == "__main__":
    ...
    user = 'root'
    password = '12132223'
    ssh = SSH(hostname=hostname, username=user, password=password)
