# Generated by Django 2.0.6 on 2020-08-15 03:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query_status', models.SmallIntegerField(choices=[(0, '未启动'), (1, '探测中'), (2, '探测完成'), (3, '路由不可达'), (4, '未知错误'), (5, '端口未开放')], default=0, verbose_name='探测状态')),
                ...
                ('created_time', models.DateTimeField(default=datetime.datetime(2020, 8, 15, 11, 33, 37, 959916), verbose_name='创建时间')),
                ('last_mod_time', models.DateTimeField(default=datetime.datetime(2020, 8, 15, 11, 33, 37, 960045), verbose_name='修改时间')),
            ],
            options={
                'verbose_name': '设备探测信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=datetime.datetime(2020, 8, 15, 11, 33, 37, 964918), verbose_name='创建时间')),
                ('last_mod_time', models.DateTimeField(default=datetime.datetime(2020, 8, 15, 11, 33, 37, 965003), verbose_name='修改时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=datetime.datetime(2020, 8, 15, 11, 33, 37, 962771), verbose_name='创建时间')),
                ('last_mod_time', models.DateTimeField(default=datetime.datetime(2020, 8, 15, 11, 33, 37, 962858), verbose_name='修改时间')),
            ],
            options={
                'verbose_name': '设备探测详情',
