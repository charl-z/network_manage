    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=datetime.datetime(2020, 9, 11, 9, 3, 52, 181393), verbose_name='创建时间')),
                ('last_mod_time', models.DateTimeField(default=datetime.datetime(2020, 9, 11, 9, 3, 52, 181432), verbose_name='修改时间')),
            ],
            options={
                'verbose_name': '设备探测信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=datetime.datetime(2020, 9, 11, 9, 3, 52, 183130), verbose_name='创建时间')),
                ('last_mod_time', models.DateTimeField(default=datetime.datetime(2020, 9, 11, 9, 3, 52, 183176), verbose_name='修改时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=datetime.datetime(2020, 9, 11, 9, 3, 52, 182242), verbose_name='创建时间')),
                ('last_mod_time', models.DateTimeField(default=datetime.datetime(2020, 9, 11, 9, 3, 52, 182273), verbose_name='修改时间')),
            ],
            options={
                'verbose_name': '设备探测详情',
